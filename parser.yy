...
%type <std::pair<std::string,ExprAST*>> param
%type <std::vector<std::pair<std::string,ExprAST*>>> params
...
params:
  %empty                { std::vector<std::pair<std::string,ExprAST*>> params; $$ = params; }
| param params          { $2.insert($2.begin(),$1); $$ = $2; };

param:
  "id"                  { std::pair<std::string,ExprAST*> p($1,nullptr); $$ = p; }
| "id" "=" expr        { std::pair<std::string,ExprAST*> p($1,$3); $$ = p; };
