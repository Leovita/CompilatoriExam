...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // params
      char dummy16[sizeof (std::vector<std::pair<std::string,ExprAST*>>)];
    };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_param = 44,                            // param
        S_expr = 45,                             // expr
        S_arglist = 46,                          // arglist
        S_args = 47,                             // args
        S_condexpr = 48,                         // condexpr
        S_pairs = 49,                            // pairs
        S_pair = 50,                             // pair
        S_boolexpr = 51,                         // boolexpr
        S_literal = 52,                          // literal
        S_relexpr = 53,                          // relexpr
        S_letexpr = 54,                          // letexpr
        S_bindings = 55,                         // bindings
        S_binding = 56                           // binding
      };
    };
